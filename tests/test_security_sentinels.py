...
class OtherAksSentinelTests(unittest.TestCase):
    ...
    def test_sentinels_do_not_touch_other_resource_types(self):
        bicep = {"type": "Microsoft.Storage/storageAccounts", "name": "st1",
                 "properties": {"accessTier": "Hot"}}
        live = {"type": "Microsoft.Storage/storageAccounts", "name": "st1",
