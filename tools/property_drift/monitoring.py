...
# ref_identity lives in primitives: it is not monitoring-specific - any
# cross-resource reference has these two spellings (live ARM id vs a bicep
# resourceId() expression). Re-exported here so monitoring's callers and
# tests keep working.
ref_identity = _primitives.ref_identity
